...
- [lihuazhang@hotmail.com](mailto:lihuazhang@hotmail.com) - `[lihuazhang@hotmail.com](mailto:lihuazhang@hotmail.com)`

### 提及用户

@lihuazhang @monkey @seveniruby ... 通过 @ 可以在发帖和回帖里面提及用户，信息提交以后，被提及的用户将会收到系统通知。以便让他来关注这个帖子或回帖。

### 表情符号 Emoji

TesterHome 支持表情符号，你可以用系统默认的 Emoji 符号（无法支持 Chrome 以及 Windows 用户）。
